...
<div class="dashboard-content">
    ...
    <div class="dashboard-grid">
        ...
        <div class="card activities-section loading">
            ...
            <div class="timeline">
                <a href="<?= BASE_URL ?>utilisateurs/ajouter" class="timeline-item timeline-button">
                ...
                <a href="<?= BASE_URL ?>equipements/ajouter" class="timeline-item timeline-button">
                ...
                <a href="#quick-report" class="timeline-item timeline-button">
    ...
    <div class="side-by-side-container" id="quick-report">
        <div class="card loading">
